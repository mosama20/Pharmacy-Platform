      ...
      <div className="w-full max-w-4xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="p-6 overflow-y-auto grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1">
          ...
          <div className="space-y-4">
            <div className="border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-950 p-2 relative group min-h-[300px] flex items-center justify-center">
              {rx.imageUrl ? (
                <img
                  src={rx.imageUrl}
                  alt="Prescription"
                  className="max-h-[350px] w-auto mx-auto object-contain rounded-xl shadow-xs transition-transform group-hover:scale-105"
                />
              ) : (
